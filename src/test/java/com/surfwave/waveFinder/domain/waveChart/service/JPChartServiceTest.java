...
class JPChartServiceTest {
    ...
    @Test
    @DisplayName("1시 31분 00초이면 당일이 dto에 포함된다")
    void getDayDto01_31_00() {
    ...
    @Test
    @DisplayName("0시 25분 00초이면 당일이 dto에 포함되지않는다")
    void getDayDto00_25_00() {
        LocalDateTime today = LocalDateTime.of(2023, 5, 28, 0, 25, 0);
        List<DayDto> dayDto = service.getDayDto(today);
    ...
    void getDayDto00_35_00() {
        LocalDateTime today = LocalDateTime.of(2023, 5, 28, 0, 35, 0);
        List<DayDto> dayDto = service.getDayDto(today);
